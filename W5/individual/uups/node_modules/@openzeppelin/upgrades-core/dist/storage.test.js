...
test('storage upgrade rename allowed', t => {
    const v1 = t.context.extractStorageLayout('StorageUpgrade_Rename_V1');
    const v2 = t.context.extractStorageLayout('StorageUpgrade_Rename_V2');
    const comparison = (0, storage_1.getStorageUpgradeErrors)(v1, v2, { unsafeAllowRenames: true });
...
test('storage upgrade with obvious mismatch', t => {
    ...
    t.like((0, storage_1.getStorageUpgradeErrors)(v1, v2_Bad), {
        length: 3,
        0: {
            kind: 'typechange',
...
test('storage upgrade with structs', t => {
    ...
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(v1, v2_Ok), []);
...
test('storage upgrade with missing struct members', t => {
    ...
    const t_struct = Object.keys(v1.types).find(t => (0, type_id_1.stabilizeTypeIdentifier)(t) === 't_struct(Struct1)storage');
    ...
    t.like((0, storage_1.getStorageUpgradeErrors)(v1, v2), {
        0: {
            kind: 'typechange',
    ...
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(v1, v2, { unsafeAllowCustomTypes: true }), []);
});
...
test('storage upgrade with missing enum members', t => {
    ...
    const t_enum = Object.keys(v1.types).find(t => (0, type_id_1.stabilizeTypeIdentifier)(t) === 't_enum(Enum1)');
    if (t_enum === undefined) {
...
test('storage upgrade with recursive type', t => {
    ...
    const e = t.throws(() => (0, storage_1.getStorageUpgradeErrors)(v1, v2));
...
test('storage upgrade with contract type', t => {
    ...
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(v1, v2), []);
});
