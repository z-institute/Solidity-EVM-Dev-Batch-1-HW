...
- Default Genesis parameter in `eth.constants`:
```python=
...
### Troubleshoot
![](https://i.imgur.com/vYMnY4l.png)
![](https://i.imgur.com/WAG8rFH.png)
![](https://i.imgur.com/ulkYzBM.png)
![](./snapshot003.png)
![](./snapshot004.png)
![](./snapshot005.png)

> There has some params became un-configurable in py-evm during London refactor
reference: https://github.com/ethereum/eth-tester/blob/master/eth_tester/backends/pyevm/main.py#L136
```
File "/Users/rshih/pyevm_test/lib/python3.7/site-packages/eth_utils/hexadecimal.py", line 20, in decode_hex
...
![](https://i.imgur.com/139a2xL.png)
![](./snapshot001.png)



## HW3
![](https://i.imgur.com/dXGXkqF.png)
![](./snapshot002.png)
