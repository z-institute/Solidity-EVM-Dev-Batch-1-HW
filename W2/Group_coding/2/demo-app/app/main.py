...
# (<ByzantiumBlock(#Block #1-0x06dc..ad42)>, Receipt(state_root=b'\x01', gas_used=21060, bloom=0, logs=()), <eth.vm.forks.byzantium.computation.ByzantiumComputation object at 0x10c2974f0>)
