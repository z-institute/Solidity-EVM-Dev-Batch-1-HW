...
class Transaction extends _Executable.default {
  ...
  freezeWith(client) {
    ...
    this._maxTransactionFee = client != null && this._maxTransactionFee == null ? client.maxTransactionFee : this._maxTransactionFee;
  ...
  async _makeRequestAsync() {
    const index = this._nextTransactionIndex * this._nodeAccountIds.length + this._nodeAccountIds.index;
  ...
  _getNodeAccountId() {
    ...
    return this._nodeAccountIds.list[this._nextNodeAccountIdIndex % this._nodeAccountIds.length];
  }
  /**
   * @internal
   * @param {?AccountId} nodeId
